...
//2.1.3 guard 语句 swift2.0后引入.与swift雷士，不同的是它只有一个代码块，并且智慧在表达式判断为false时执行后续代码块，否则会跳出整个guard
    //语法格式
 ...
 */
/*
 tips:1、index常量只存在于循环的声明周期里。如果想在循环完成后访问index的值，或者想让index成为一个变量而不是常量，必须在循环之前进行声明
